...
int main(void){
    ...
    printf("Experimentos em Coelhos: %3.0i - %3.2f%\n", qntdC, (float)(100*qntdC/qntdTotal));
    printf("Experimentos em Ratos:   %3.0i - %3.2f%\n", qntdR, (float)(100*qntdR/qntdTotal));
    printf("Experimentos em Sapos:   %3.0i - %3.2f%\n", qntdS, (float)(100*qntdS/qntdTotal));
